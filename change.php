...
echo "<tr><td>Id Usuario</td><td>Nombre</td><td>Apellido</td><td>Correo</td><td>Contraseña</td><td></td></tr>";
while ($row = mysqli_fetch_array($datos)) {
    ...
    echo "<td><a href='changes_u.php?codUser=".$row['id_user']."'>Cambiar</a></td>";
	echo "<td><a href='drop_user.php?codUser=".$row['id_user']."'>Eliminar</a></td>";
