				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Section -->
								<section>
									<center><h1>Cambiar Datos Editorial</h1></center>    
<h6>Requerido *</h6>
    <form  action ="new_editorial.php" method="post">
        <center><label>Id Editorial: </label><input type="text"  name="id_editorial" value="<?php echo $_GET['codedi']; ?>"></center><br>
        <center><label>Nombre Editorial: *</label><input type="text" name="name_editorial" required=""></center><br>
        <center><label>Url: *</label><input type="text" name="url" required=""></center><br>
