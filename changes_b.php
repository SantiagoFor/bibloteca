				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Section -->
								<section>
									<center><h1>Cambiar Datos Libro</h1></center>    
<h6>Requerido *</h6>
    <form  action ="new_book.php" method="post">
        <center><label>Id Libro: </label><input type="text"  name="id_book" value="<?php echo $_GET['codBook']; ?>"></center><br>
        <center><label>Nombre: *</label><input type="text" name="name" required=""></center><br>
        <center><label>Autor: *</label><input type="text" name="author" required=""></center><br>
        <center><label>Reseña: </label><input type="text" name="reviews"></center><br>
        <center><label>Enlace de Imagen: *</label><input type="text" name="read_down" required=""></center><br>
        <center><label>Id Genero: *</label><input type="text" name="id_gender" required=""></center><br>
