...
<html>
    ...
    <form action="verify.php" method="post">
        <center><label>Correo: </label><input type="text" name="mail" autocomplete="off" required=""></center><br>
        <center><label>Contraseña:</label><input type="password" name="password" autocomplete="off" required=""></center><br>
        <center><input type="submit" value="Ir">   
        <hr/>
    </form>    
								</section>
