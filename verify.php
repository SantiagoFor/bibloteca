...
$pasw=$_POST['password'];
$cont=0;
$consulta = "select * from users where mail='$mail' and password='$pasw'";
...
if($cont==1){
	$_SESSION['mail']=$mail;
    echo '<script> alert("Iniciando sesión para '.$_SESSION['mail'].' ");</script><p>';
    echo '<script> window.location="index_loger.html"; </script>';
