...
<html>
	...
	<body>
        ...
        $consulta = "update books set name = '$name' ,author='$aut', reviews = '$revi', read_down='$redo', id_gender =$idg  where id_book = $idbk" ;
						...
						<div class="inner">
							...
							<!-- Section -->
								<section>
									...
									<p>
In case you can not find a book you want to add to the virtual library contact us at the following email or phone.</p>
									<ul class="contact">
