				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Section -->
								<section>
									<center><h1>Cambiar Datos Genero</h1></center>  
<h3>Requerido *</h3>                                                                        
    <form  action ="new_gender.php" method="post">
        <center><label>Id Genero: </label><input type="text" name="id_gender" value="<?php echo $_GET['codgender']; ?>"></center><br>
        <center><label>Genero: *</label><input type="text" name="gender" required=""></center><br>
