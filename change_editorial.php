...
echo "<tr><td>Id Editorial</td><td>Nombre</td><td>Url</td><td>Cambiar</td><td>Eliminar</td></tr>";
while ($row = mysqli_fetch_array($datos)) {
    echo '<tr>';
    echo "<td>" . $row['id_editorial'] . "</td>";
    echo "<td>" . $row['name_editorial'] . "</td>";
    echo "<td><a href=".$row['url'].">URL</a></td>";
    echo "<td><a href='changes_e.php?codedi=".$row['id_editorial']."'>Cambiar</a></td>";
	echo "<td><a href='drop_editorial.php?codedi=".$row['id_editorial']."'>Eliminar</a></td>";
}
